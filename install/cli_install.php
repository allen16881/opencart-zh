...
//                               --http_server http://localhost/CNOpencart/
//
...
function setup_db($data) {
	...
	if ($lines) {
		...
		$db->query("INSERT INTO `" . $data['db_prefix'] . "user` SET user_id = '1', user_group_id = '1', username = '" . $db->escape($data['username']) . "', salt = '" . $db->escape($salt = token(9)) . "', password = '" . $db->escape(sha1($salt . sha1($salt . sha1($data['password'])))) . "', firstname = '', lastname = '', fullname = 'John', email = '" . $db->escape($data['email']) . "', status = '1', date_added = NOW()");
...
function write_config_files($options) {
	...
	$output .= '// DIR' . "\n";
	$output .= 'define(\'DIR_MAIN\', \'' . addslashes(DIR_OPENCART) . '\');' . "\n";
	$output .= 'define(\'DIR_APPLICATION\', DIR_MAIN . \'catalog/\');' . "\n";
	$output .= 'define(\'DIR_SYSTEM\', DIR_MAIN . \'system/\');' . "\n";
	$output .= 'define(\'DIR_IMAGE\', DIR_MAIN . \'uploads/\');' . "\n";
	$output .= 'define(\'DIR_STORAGE\', DIR_MAIN . \'storage/\');' . "\n";
	$output .= 'define(\'DIR_LANGUAGE\', DIR_APPLICATION . \'language/\');' . "\n";
	$output .= 'define(\'DIR_TEMPLATE\', DIR_MAIN . \'themes/\');' . "\n";
	...
	$output .= '// DIR' . "\n";
	$output .= 'define(\'DIR_MAIN\', \'' . addslashes(DIR_OPENCART) . '\');' . "\n";
	$output .= 'define(\'DIR_APPLICATION\', DIR_MAIN . \'admin/\');' . "\n";
	$output .= 'define(\'DIR_SYSTEM\', DIR_MAIN . \'system/\');' . "\n";
	$output .= 'define(\'DIR_IMAGE\', DIR_MAIN . \'uploads/\');' . "\n";
	$output .= 'define(\'DIR_STORAGE\', DIR_MAIN . \'storage/\');' . "\n";
	$output .= 'define(\'DIR_CATALOG\', DIR_MAIN . \'catalog/\');' . "\n";
	$output .= 'define(\'DIR_LANGUAGE\', DIR_APPLICATION . \'language/\');' . "\n";
	$output .= 'define(\'DIR_TEMPLATE\', DIR_APPLICATION . \'view/template/\');' . "\n";
	$output .= 'define(\'DIR_TEMPLATE_CATALOG\', DIR_MAIN . \'themes/\');' . "\n";
	$output .= 'define(\'DIR_CONFIG\', DIR_SYSTEM . \'config/\');' . "\n";
	$output .= 'define(\'DIR_CACHE\', DIR_STORAGE . \'cache/\');' . "\n";
	$output .= 'define(\'DIR_DOWNLOAD\', DIR_STORAGE . \'download/\');' . "\n";
	$output .= 'define(\'DIR_LOGS\', DIR_STORAGE . \'logs/\');' . "\n";
	...
	$output .= 'define(\'CNOC_SERVER\', \'https://cnopencart.com/\');' . "\n";
...
function dir_permissions() {
	$dirs = array(
		DIR_OPENCART . 'uploads/',
		DIR_OPENCART . 'storage/download/',
		DIR_OPENCART . 'storage/upload/',
		DIR_OPENCART . 'storage/cache/',
		DIR_OPENCART . 'storage/logs/',
		DIR_OPENCART . 'storage/modification/',
	);
...
case "install":
	try {
		...
		install($options);
		echo "SUCCESS! CNOpencart successfully installed on your server\n";
