...
class ControllerInstallStep2 extends Controller {
	...
	public function index() {
		...
		} else if (!is_writable(DIR_OPENCART . 'config.php')) {
		...
		$data['image'] = DIR_OPENCART . 'uploads';
		$data['image_cache'] = DIR_OPENCART . 'uploads/cache';
		$data['image_catalog'] = DIR_OPENCART . 'uploads/catalog';
		$data['cache'] = DIR_OPENCART . 'storage/cache';
		$data['logs'] = DIR_OPENCART . 'storage/logs';
		$data['download'] = DIR_OPENCART . 'storage/download';
		$data['upload'] = DIR_OPENCART . 'storage/upload';
		$data['modification'] = DIR_OPENCART . 'storage/modification';
	...
	private function validate() {
		...
		if (!is_writable(DIR_OPENCART . 'storage/cache')) {
