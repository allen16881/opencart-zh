...
class ControllerInstallStep3 extends Controller {
	...
	public function index() {
		...
		$data['text_insert_demo'] = $this->language->get('text_insert_demo');
		...
		if (isset($this->request->post['insert_demo'])) {
			$data['insert_demo'] = $this->request->post['insert_demo'];
		} else {
			$data['insert_demo'] = 0;
		}
		...
		} else if (isset($this->session->data['language'])) {
			$data['language'] = $this->session->data['language'];
		} else {
			$data['language'] = $this->config->get('language_default');
		}
		...
		foreach ($language_files as $file) {
			...
			$language['current'] = $code == $data['language'];
	...
	private function validate() {
		...
		if ($this->request->post['db_driver'] == 'mysqli') {
			try {
				...
				$this->error['warning'] = $this->language->get('error_db_connect');//$mysql->connect_error;
			}
