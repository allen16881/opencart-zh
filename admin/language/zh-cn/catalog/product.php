...
$_['text_percent']           = '百分比';
$_['text_amount']            = '固定金额';
$_['text_keyword']           = '请勿使用空格，使用“-”代替空格，并确认自定义链接（SEO URL）的唯一性。';
...
$_['help_minimum']           = '最低消费';
$_['help_stock_status']      = '商品缺货状态显示';
$_['help_points']            = '购买这个项目所需的积分数量。如果您不想使用积分购买本商品请设定为 0。';
...
$_['error_permission']       = '警告: 您没有权限修改商品 ！';
$_['error_name']             = '商品名称必须是大于 1 且小于 255 个字符 ！';
$_['error_meta_title']       = 'Meta 标题必须大于 1 和少于 255 个字符 ！';
$_['error_model']            = '商品编号必须是大于 1 且小于 64 个字符 ！';
$_['error_keyword']          = '链接关键字已被使用！';
$_['error_unique']           = '自定义链接必须是没有重复的！';