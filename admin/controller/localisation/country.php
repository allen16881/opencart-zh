	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['countries'][] = array(
				...
				'name'       => $result['name'],
				'default'    => $result['country_id'] == $this->config->get('config_country_id') ? $this->language->get('text_default') : false,
				...
				'list'       => $this->url->link('localisation/zone', 'user_token=' . $this->session->data['user_token'] . '&country_id=' . $result['country_id'] . $url, true)
			);
		}
		...
		$data['sort_sort_order'] = $this->url->link('localisation/country', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, true);
