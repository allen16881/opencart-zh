...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['sort_product_id'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.product_id' . $url, true);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_child'])) {
			$products = $this->request->post['product_child'];
		} elseif (isset($this->request->get['product_id'])) {
			$products = $this->model_catalog_product->getProductChild($this->request->get['product_id']);
		} else {
			$products = array();
		}

		$data['product_children'] = array();
