...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'cms/content')) {
				$cms[] = array(
					'name'	   => $this->language->get('text_article'),
					'href'     => $this->url->link('cms/content', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'cms/category')) {
				$cms[] = array(
					'name'	   => $this->language->get('text_article_category'),
					'href'     => $this->url->link('cms/category', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/app')) {
				$marketplace[] = array(
					'name'	   => $this->language->get('text_app'),
					'href'     => $this->url->link('extension/app', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'extension/extension/theme')) {
				$marketplace[] = array(
					'name'	   => $this->language->get('text_theme'),
					'href'     => $this->url->link('marketplace/extension', 'type=theme&user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/extension/payment')) {
				$marketplace[] = array(
			...
			if ($this->user->hasPermission('access', 'extension/extension/shipping')) {
				$marketplace[] = array(
					'name'	   => $this->language->get('text_shipping'),
					'href'     => $this->url->link('marketplace/extension', 'type=shipping&user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
