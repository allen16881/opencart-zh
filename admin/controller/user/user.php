...
class ControllerUserUser extends Controller {
	...
	protected function getList() {
		...
		$data['sort_fullname'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&sort=fullname' . $url, true);
		$data['sort_email'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&sort=email' . $url, true);
		$data['sort_telephone'] = $this->url->link('user/user', 'user_token=' . $this->session->data['user_token'] . '&sort=telephone' . $url, true);
