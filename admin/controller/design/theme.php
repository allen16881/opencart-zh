...
class ControllerDesignTheme extends Controller {
	...
	public function path() {
		...
		if (substr(str_replace('\\', '/', realpath($theme_dir . 'default/template/' . $path)), 0, strlen($theme_dir)) == $theme_dir) {
			$path_data = array();
			...
			$files = glob(rtrim($theme_dir . '{default,' . $theme . '}/template/' . $path, '/') . '/*', GLOB_BRACE);
	...
	public function template() {
		...
		} elseif (is_file(DIR_MAIN . 'themes/' . $theme . '/template/' . $path) && (substr(str_replace('\\', '/', realpath(DIR_MAIN . 'themes/' . $theme . '/template/' . $path)), 0, strlen(DIR_MAIN . 'themes')) == DIR_MAIN . 'themes')) {
			$json['code'] = file_get_contents(DIR_MAIN . 'themes/' . $theme . '/template/' . $path);
		} elseif (is_file(DIR_MAIN . 'themes/default/template/' . $path) && (substr(str_replace('\\', '/', realpath(DIR_MAIN . 'themes/default/template/' . $path)), 0, strlen(DIR_MAIN . 'view')) == DIR_MAIN . 'view')) {
			$json['code'] = file_get_contents(DIR_MAIN . 'themes/default/template/' . $path);
		}
	...
	public function reset() {
		...
		if (is_file(DIR_MAIN . 'themes/' . $theme . '/template/' . $path) && (substr(str_replace('\\', '/', realpath(DIR_MAIN . 'themes/' . $theme . '/template/' . $path)), 0, strlen(DIR_MAIN . 'themes')) == DIR_MAIN . 'themes')) {
			$json['code'] = file_get_contents(DIR_MAIN . 'themes/' . $theme . '/template/' . $path);
		}
