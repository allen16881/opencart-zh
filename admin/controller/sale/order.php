...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		if (!empty($data['payment_zone_id'])) {
			$data['payment_cities'] = $this->model_localisation_zone->getZonesByParentId($data['payment_zone_id']);
		}

		if (!empty($data['payment_city_id'])) {
			$data['payment_districts'] = $this->model_localisation_zone->getZonesByParentId($data['payment_city_id']);
		}
		...
		if (!empty($data['shipping_zone_id'])) {
			$data['shipping_cities'] = $this->model_localisation_zone->getZonesByParentId($data['shipping_zone_id']);
		}

		if (!empty($data['shipping_city_id'])) {
			$data['shipping_districts'] = $this->model_localisation_zone->getZonesByParentId($data['shipping_city_id']);
		}
		...
		if ($this->config->get('payment_address')) {
			$data['payment_address_required'] = true;
		}
