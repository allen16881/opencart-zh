...
class ControllerExtensionThemeDefault extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['cms_content_limit'])) {
			$data['error_cms_content_limit'] = $this->error['cms_content_limit'];
		} else {
			$data['error_cms_content_limit'] = '';
		}

		if (isset($this->error['cms_description_length'])) {
			$data['error_cms_description_length'] = $this->error['cms_description_length'];
		} else {
			$data['error_cms_description_length'] = '';
		}
		...
		if (isset($this->error['image_avatar'])) {
			$data['error_image_avatar'] = $this->error['image_avatar'];
		} else {
			$data['error_image_avatar'] = '';
		}
		...
		$data['menus']=$this->model_design_menu->getMenusList();

		if (isset($this->request->post['theme_default_menu_top'])) {
			$data['theme_default_menu_top'] = $this->request->post['theme_default_menu_top'];
		} elseif (isset($setting_info['theme_default_menu_top'])) {
			$data['theme_default_menu_top'] = $setting_info['theme_default_menu_top'];
		} else {
			$data['theme_default_menu_top'] = 0;
		}
		
		$data['directories'] = array();

		$directories = glob(DIR_MAIN . 'themes/*', GLOB_ONLYDIR);
		...
		if (isset($this->request->post['theme_default_cms_content_limit'])) {
			$data['theme_default_cms_content_limit'] = $this->request->post['theme_default_cms_content_limit'];
		} elseif (isset($setting_info['theme_default_cms_content_limit'])) {
			$data['theme_default_cms_content_limit'] = $setting_info['theme_default_cms_content_limit'];
		} else {
			$data['theme_default_cms_content_limit'] = 10;
		}
		
		if (isset($this->request->post['theme_default_cms_description_length'])) {
			$data['theme_default_cms_description_length'] = $this->request->post['theme_default_cms_description_length'];
		} elseif (isset($setting_info['theme_default_cms_description_length'])) {
			$data['theme_default_cms_description_length'] = $setting_info['theme_default_cms_description_length'];
		} else {
			$data['theme_default_cms_description_length'] = 150;
		}
		...
		if (isset($this->request->post['theme_default_image_category_width'])) {
			...
			$data['theme_default_image_category_width'] = 200;		
		}
		...
		if (isset($this->request->post['theme_default_image_thumb_width'])) {
			...
			$data['theme_default_image_thumb_width'] = 200;
		}
		...
		if (isset($this->request->post['theme_default_image_thumb_height'])) {
			...
			$data['theme_default_image_thumb_height'] = 200;		
		}
		...
		if (isset($this->request->post['theme_default_image_product_height'])) {
			...
			$data['theme_default_image_product_height'] = 500;
		}
		...
		if (isset($this->request->post['theme_default_image_additional_height'])) {
			...
			$data['theme_default_image_additional_height'] = 100;
		}
		...
		if (isset($this->request->post['theme_default_image_related_width'])) {
			...
			$data['theme_default_image_related_width'] = 200;
		}
		...
		if (isset($this->request->post['theme_default_image_compare_width'])) {
			...
			$data['theme_default_image_compare_width'] = 200;
		}
		...
		if (isset($this->request->post['theme_default_image_wishlist_width'])) {
			...
			$data['theme_default_image_wishlist_width'] = 200;
		}
		...
		if (isset($this->request->post['theme_default_image_wishlist_height'])) {
			...
			$data['theme_default_image_wishlist_height'] = 200;
		}
		...
		if (isset($this->request->post['theme_default_image_cart_width'])) {
			...
			$data['theme_default_image_cart_width'] = 120;
		}
		...
		if (isset($this->request->post['theme_default_image_cart_height'])) {
			...
			$data['theme_default_image_cart_height'] = 120;
		}
		...
		if (isset($this->request->post['theme_default_image_location_width'])) {
			...
			$data['theme_default_image_location_width'] = 500;
		}
		...
		if (isset($this->request->post['theme_default_image_location_height'])) {
			...
			$data['theme_default_image_location_height'] = 300;
		}
		
		if (isset($this->request->post['theme_default_image_avatar_width'])) {
			$data['theme_default_image_avatar_width'] = $this->request->post['theme_default_image_avatar_width'];
		} elseif (isset($setting_info['theme_default_image_avatar_width'])) {
			$data['theme_default_image_avatar_width'] = $setting_info['theme_default_image_avatar_width'];
		} else {
			$data['theme_default_image_avatar_width'] = 120;
		}
		
		if (isset($this->request->post['theme_default_image_avatar_height'])) {
			$data['theme_default_image_avatar_height'] = $this->request->post['theme_default_image_avatar_height'];
		} elseif (isset($setting_info['theme_default_image_avatar_height'])) {
			$data['theme_default_image_avatar_height'] = $setting_info['theme_default_image_avatar_height'];
		} else {
			$data['theme_default_image_avatar_height'] = 120;
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['theme_default_product_description_length']) {
			$this->error['product_description_length'] = $this->language->get('error_length');
		}

		if (!$this->request->post['theme_default_cms_content_limit']) {
			$this->error['cms_content_limit'] = $this->language->get('error_limit');
		}

		if (!$this->request->post['theme_default_cms_description_length']) {
			$this->error['cms_description_length'] = $this->language->get('error_length');
		}
		...
		if (!$this->request->post['theme_default_image_avatar_width'] || !$this->request->post['theme_default_image_avatar_height']) {
			$this->error['image_avatar'] = $this->language->get('error_image_avatar');
		}
