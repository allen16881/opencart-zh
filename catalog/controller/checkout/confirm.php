...
class ControllerCheckoutConfirm extends Controller {
	public function index() {
		...
		if (!isset($this->session->data['payment_address']) && $this->config->get('payment_address')) {
			$redirect = $this->url->link('checkout/checkout', '', true);
		}
		...
		if (!$redirect) {
			...
			if ($this->customer->isLogged()) {
				...
				$order_data['fullname'] = isset($this->session->data['guest']['fullname']) ? $this->session->data['guest']['fullname'] : '';
			...
			$order_data['payment_fullname'] = isset($this->session->data['payment_address']['fullname']) ? $this->session->data['payment_address']['fullname'] : '';
			$order_data['payment_telephone'] = isset($this->session->data['payment_address']['telephone']) ? $this->session->data['payment_address']['telephone'] : '';
			...
			$order_data['payment_zone_id'] = isset($this->session->data['payment_address']['zone_id']) ? $this->session->data['payment_address']['zone_id'] : 0;
			$order_data['payment_country'] = isset($this->session->data['payment_address']['country']) ? $this->session->data['payment_address']['country'] : '';
			$order_data['payment_country_id'] = isset($this->session->data['payment_address']['country_id']) ? $this->session->data['payment_address']['country_id'] : 0;
			$order_data['payment_city'] = isset($this->session->data['payment_address']['city']) ? $this->session->data['payment_address']['city'] : '';
			$order_data['payment_city_id'] = isset($this->session->data['payment_address']['city_id']) ? $this->session->data['payment_address']['city_id'] : 0;
			$order_data['payment_district'] = isset($this->session->data['payment_address']['district']) ? $this->session->data['payment_address']['district'] : '';
			$order_data['payment_district_id'] = isset($this->session->data['payment_address']['district_id']) ? $this->session->data['payment_address']['district_id'] : 0;
			...
			if ($this->cart->hasShipping()) {
				...
				$order_data['shipping_fullname'] = isset($this->session->data['shipping_address']['fullname']) ? $this->session->data['shipping_address']['fullname'] : '';
				...
				$order_data['shipping_district'] = isset($this->session->data['shipping_address']['district']) ? $this->session->data['shipping_address']['district'] : '';
