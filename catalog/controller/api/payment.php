	...
	public function address() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if (isset($this->request->post['zone_id']) && $this->request->post['zone_id'] > 0) {
				...
				if ($cities && (!isset($this->request->post['city_id']) || !$this->request->post['city_id'])) {
					$json['error']['city'] = $this->language->get('error_city');
				}
			}
			...
			if (isset($this->request->post['city_id']) && $this->request->post['city_id'] > 0) {
				...
				if ($districts && (!isset($this->request->post['district_id']) || !$this->request->post['district_id'])) {
			...
			if (!$json) {
				...
				$this->session->data['payment_address'] = array(
					...
					'city'           => $city ? $city : $this->request->post['city'],
