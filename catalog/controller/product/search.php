...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['keyword'])) {
			$data['heading_title'] = $this->language->get('heading_title') .  ' - ' . $this->request->get['keyword'];
		} else {
		...
		if (isset($this->request->get['keyword']) || isset($this->request->get['tag'])) {
			$filter_data = array(
				'filter_name'         => $keyword,
				'filter_tag'          => $tag,
			...
			$data['sorts']['default'] = array(
				...
				'href'  => $this->url->link('product/search', $url)//'sort=p.sort_order&order=ASC' . 
			);
			...
			if (isset($this->request->get['keyword']) && $this->config->get('config_customer_search')) {
